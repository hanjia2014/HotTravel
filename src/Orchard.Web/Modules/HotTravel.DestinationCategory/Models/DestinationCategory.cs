...
namespace HotTravel.DestinationCategory.Models
{
    ...
    public class DestinationCategoryPart : ContentPart<DestinationCategoryPartRecord>
    {
        ...
        public string Item2Title { get { return Retrieve(p => p.Item1Title); } set { Store(p => p.Item1Title, value); } }
        public string Item2Location { get { return Retrieve(p => p.Item1Location); } set { Store(p => p.Item1Location, value); } }
        public string Item2LinkedPage { get { return Retrieve(p => p.Item1LinkedPage); } set { Store(p => p.Item1LinkedPage, value); } }

        public string Item3Title { get { return Retrieve(p => p.Item1Title); } set { Store(p => p.Item1Title, value); } }
        public string Item3Location { get { return Retrieve(p => p.Item1Location); } set { Store(p => p.Item1Location, value); } }
        public string Item3LinkedPage { get { return Retrieve(p => p.Item1LinkedPage); } set { Store(p => p.Item1LinkedPage, value); } }
    }
}
